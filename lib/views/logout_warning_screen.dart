...
class LogoutWarningScreen extends ConsumerWidget {
  ...
  void _proceedToLandingPage(BuildContext context, WidgetRef ref) {
    ...
    // This drops the state to AuthInitial and GoRouter automatically teleports user to the Landing Page!
    // It purposefully leaves the old session on the hard drive so user can easily switch back.
